...
ENV MAILER_SENDER_EMAIL ${MAILER_SENDER_EMAIL}
...
ENV SMTP_AUTHENTICATION ${SMTP_AUTHENTICATION}

ARG SMTP_ENABLE_STARTTLS_AUTO
ENV SMTP_ENABLE_STARTTLS_AUTO ${SMTP_ENABLE_STARTTLS_AUTO}

ARG SMTP_OPENSSL_VERIFY_MODE
ENV SMTP_OPENSSL_VERIFY_MODE ${SMTP_OPENSSL_VERIFY_MODE}

ARG MAILER_INBOUND_EMAIL_DOMAIN
ENV MAILER_INBOUND_EMAIL_DOMAIN ${MAILER_INBOUND_EMAIL_DOMAIN}
